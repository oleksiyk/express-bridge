...
/**
 * Configure Express-Bridge
 *
 * @param _options
 * @api public
 */
module.exports.configure = function(_options){
    options = _.partialRight(_.merge, _.defaults)(_options || {}, options);
}
 ...
 * @api public
 */
module.exports.include = function (files) {
 ...
 * @api public
 */
module.exports.add = add = function (path, handlers) {
    ...
    parsedPromise.then(function () {
        controllersInfo.forEach(function (controller) {
            ...
            controller.methods.forEach(function (method) {
                ...
                console.log(method.route, method.returns);
